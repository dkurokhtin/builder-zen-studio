...
export default function Config() {
  ...
  const vpnConfig = {
    ...
    qrCodeData:
      "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAQAAAAEAAQMAAABmvDolAAAABlBMVEX///8AAABVwtN+AAAHBUlEQVR42u...", // Base64 QR код
    serverInfo: {
      location: "Нидерланды",
      ping: "23ms",
      speed: "1000 Мбит/с",
                ...
                <div className="grid grid-cols-2 gap-4 text-center">
                  <div>
                    <div className="text-lg font-bold">
                      {vpnConfig.serverInfo.ping}
                    </div>
                    <div className="text-xs text-white/70">Пинг</div>
                  </div>
                  <div>
                    <div className="text-lg font-bold">
                      {vpnConfig.serverInfo.speed}
                    </div>
